...
export default function CircularQueue() {
  ...
  const codeData = [
    ...
    { 
      line: "#define MAX 5", 
      explanation: "Defines maximum capacity of the circular queue.",
      important: true 
    },
    { 
      line: "int queue[MAX];", 
      explanation: "Array declaration for circular queue implementation.",
      important: true 
    },
    { 
    ...
    { 
      ...
      explanation: "Function to add an element to the circular queue.",
      important: true 
    },
    { 
      line: "    if ((rear + 1) % MAX == front) {", 
      explanation: "Check if circular queue is full (wraps around to front).",
      important: true 
    },
    { 
    ...
    { 
      line: "    rear = (rear + 1) % MAX;", 
      explanation: "Circular increment of rear pointer (wraps around).",
      important: true 
    },
    { 
    ...
    { 
      line: "    if (front == rear) front = rear = -1;", 
      explanation: "Reset pointers if last element is dequeued.",
      important: true 
    },
    { 
      line: "    else front = (front + 1) % MAX;", 
      explanation: "Circular increment of front pointer (wraps around).",
      important: true 
    },
    { 
    ...
    { 
      line: "void display() {", 
      explanation: "Function to display circular queue contents.",
      important: true 
    },
    { 
      line: "    if (front == -1) {", 
    ...
    { 
      line: "        return;", 
      explanation: "Exit function if empty.",
      important: true 
    },
    { 
      line: "    }", 
    ...
    { 
      line: "    printf(\"Queue elements: \");", 
      explanation: "Print queue elements label.",
      important: false 
    },
    { 
      line: "    int i = front;", 
      explanation: "Start iterator at front.",
      important: true 
    },
    { 
      line: "    if (front <= rear) {", 
      explanation: "Case when queue is not wrapped around.",
      important: true 
    },
    { 
      line: "        while (i <= rear)", 
      explanation: "Loop from front to rear.",
      important: true 
    },
    { 
      line: "            printf(\"%d \", queue[i++]);", 
      explanation: "Print elements in order.",
      important: true 
    },
    { 
      line: "    } else {", 
      explanation: "Case when queue is wrapped around.",
      important: true 
    },
    { 
      line: "        while (i < MAX)", 
      explanation: "Loop from front to end of array.",
      important: true 
    },
    { 
      line: "            printf(\"%d \", queue[i++]);", 
      explanation: "Print elements from front to end.",
      important: true 
    },
    { 
      line: "        i = 0;", 
      explanation: "Reset iterator to start of array.",
      important: true 
    },
    { 
      line: "        while (i <= rear)", 
      explanation: "Loop from start to rear.",
      important: true 
    },
    { 
      line: "            printf(\"%d \", queue[i++]);", 
      explanation: "Print elements from start to rear.",
      important: true 
    },
    { 
      line: "    }", 
      explanation: "End of display cases.",
      important: false 
    },
    { 
      line: "    printf(\"\\n\");", 
    ...
    { 
      line: "    return ((rear + 1) % MAX == front);", 
      explanation: "Return true if next rear would equal front.",
      important: true 
    },
    { 
      line: "}", 
  ...
  const quizQuestions = [
    ...
    },
    {
      ...
      answer: 2,
      explanation: "The circular queue is full when the next rear position would equal front."
    },
    {
    ...
    {
      question: "What is the time complexity of enqueue/dequeue in circular queue?",
      options: ["O(1)", "O(n)", "O(log n)", "O(n²)"],
      answer: 0,
      explanation: "Both operations are O(1) as they only access the front/rear elements."
    },
    {
      question: "When is front reset to -1 in circular queue?",
      options: [
        "When queue becomes empty",
        "When rear reaches MAX-1",
        "When front reaches rear",
        "Never"
      ],
      answer: 0,
      explanation: "Front is set to -1 when the queue becomes empty after dequeue."
    }
  ];
      ...
      {showQuiz ? (
        <div className="w-full max-w-6xl p-4 rounded-lg shadow-lg bg-gray-800 border border-gray-700">
          <div className="space-y-4">
                  ...
                  className={`w-full text-left p-3 rounded-md border ${
                    userAnswer === idx
                      ? idx === quizQuestion.answer
                        ? 'bg-green-900 border-green-500 text-blue-100'
            ...
            {userAnswer !== null && (
              <div className={`p-3 rounded-md ${quizQuestion.answer === userAnswer ? 'bg-green-900 text-blue-100' : 'bg-red-900 text-red-100'}`}>
            ...
            <div className="p-4 rounded-lg shadow-lg flex-1 bg-gray-800 border border-gray-700">
              {showTable ? (
                ...
                <div className="relative">
                  <h2 className="text-xl font-semibold mb-3 text-green-400">Circular Queue Implementation</h2>
            ...
            <div className="flex-1">
              {showTable ? (
                ...
                <div className="p-4 rounded-lg shadow-lg bg-gray-800 h-full border border-gray-700">
                  <h2 className="text-xl font-semibold mb-3 text-green-400">Circular Queue Visualization</h2>
                    ...
                    <div className="relative w-full border-2 border-gray-600 rounded-lg bg-gray-700 flex flex-col items-center p-4">
                      <div className="w-full max-w-md">
                        ...
                        <div className="relative h-64 w-full mb-6">
                          ...
                          <svg className="w-full h-full" viewBox="0 0 200 200">
                            ...
                            {Array.from({ length: capacity }).map((_, idx) => {
                              ...
                              const isActive = front !== -1 && 
                                ((front <= rear && idx >= front && idx <= rear) || 
                                 (front > rear && (idx >= front || idx <= rear)));
                              
                              return (
                                <g key={idx} transform={`translate(${x}, ${y})`}>
                                  <circle cx="0" cy="0" r="20" fill={isActive ? "#1E40AF" : "#374151"} />
                                  <text 
                                    x="0" 
                                    y="5" 
                                    textAnchor="middle" 
                                  ...
                                  {idx === front && (
                                    <text x="25" y="0" fill="#3B82F6" className="text-xs">front</text>
                                  )}
                                  {idx === rear && !isActive && (
                                    <text x="25" y="0" fill="#3B82F6" className="text-xs">rear</text>
                                  )}
                                </g>
                              );
                            })}
                            ...
                            {/* Connection lines */}
                            {Array.from({ length: capacity }).map((_, idx) => {
                              const nextIdx = (idx + 1) % capacity;
                              const angle1 = (idx * (360 / capacity) - 90);
                              const angle2 = (nextIdx * (360 / capacity)) - 90;
                              const x1 = 100 + 60 * Math.cos(angle1 * (Math.PI / 180));
                              const y1 = 100 + 60 * Math.sin(angle1 * (Math.PI / 180));
                              const x2 = 100 + 60 * Math.cos(angle2 * (Math.PI / 180));
                              const y2 = 100 + 60 * Math.sin(angle2 * (Math.PI / 180));
                        ...
                        <div className="flex gap-3 mt-4">
                          ...
                          <button
                            onClick={enqueue}
                            disabled={(rear + 1) % capacity === front}
              ...
              <table className="w-full border-collapse text-sm">
                <thead>
                  <tr className="bg-gray-700">
                    ...
                    <th className="p-2 border border-gray-600">Linear Queue</th>
                ...
                <tbody>
                  <tr className="bg-gray-800">
                    ...
                    <td className="p-2 border border-gray-600">Fixed size, better utilization</td>
                  </tr>
                  <tr className="bg-gray-700">
                  ...
                  <tr className="bg-gray-800">
                    ...
                    <td className="p-2 border border-gray-600">More complex with modulo</td>
                  </tr>
                  <tr className="bg-gray-700">
                  ...
                  <tr className="bg-gray-800">
                    <td className="p-2 border border-gray-600 font-medium">Memory Reuse</td>
                    <td className="p-2 border border-gray-600">No reuse of dequeued space</td>
                    <td className="p-2 border border-gray-600">Reuses dequeued space</td>
                  </tr>
                  <tr className="bg-gray-700">
                    ...
                    <td className="p-2 border border-gray-600">When frequent enqueue/dequeue expected</td>
                  </tr>
                </tbody>
              </table>
            </div>
